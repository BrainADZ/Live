...
const faqs = [
  {
    q: "What is a Vertical Floor Mount Digital Kiosk?",
    a: "A Vertical Floor Mount Digital Kiosk is a freestanding screen-based signage unit used to display videos, images, promotions, announcements and business information in customer-facing spaces.",
  },
  {
  ...
  {
    q: "Can the Vertical Floor Mount Digital Kiosk be customized?",
...
export default function VerticalFloorMountDigitalKioskPage() {
    ...
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          ...
          alt="Vertical Floor Mount Digital Kiosk by BrainADZ Live"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-4 lg:min-h-135 lg:px-12">
          <div className="flex items-center gap-3 text-[16px] font-light md:text-[18px]">
            ...
            <span className="text-white/90">Vertical Floor Mount Digital Kiosk</span>
          </div>

          <div className="mt-12 max-w-205 md:mt-14">
            <h1 className="text-[38px] font-semibold leading-[1.15] tracking-[-1.2px] text-white md:text-[48px] lg:text-[56px]">
              Vertical Floor Mount Digital Kiosk for Customer-Facing Communication
            </h1>
          </div>
        ...
        <div className="mx-auto grid max-w-450 gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70">
              The BrainADZ Live Vertical Floor Mount Digital Kiosk is a screen-based
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-4 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          <div>
            <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.18em] text-[#193175]">
              Why Choose a Vertical Floor Mount Digital Kiosk
            </p>
        ...
        <div className="mx-auto grid max-w-450 gap-16 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-[16px] font-light leading-[1.75] text-black/65">
              Vertical Floor Mount Digital Kiosks provide a dedicated screen-based
          ...
          <div className="mb-12 flex flex-col justify-between gap-7 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="max-w-195 text-[34px] font-normal leading-[1.15] tracking-[-1px] md:text-[46px]">
                Vertical Floor Mount Digital Kiosk views and deployment examples.
              </h2>
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-4">
            {[
              ...
              >
                <img
                  src={image}
                  alt={`Vertical Floor Mount Digital Kiosk Gallery ${index + 1}`}
        ...
        <div className="mx-auto max-w-450 px-4 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#193175] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                src="/CTA/cta.webp"
                alt="Vertical Floor Mount Digital Kiosk showcase"
                loading="lazy"
                decoding="async"
