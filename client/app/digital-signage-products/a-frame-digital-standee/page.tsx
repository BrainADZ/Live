...
const faqs = [
  {
    q: "What is an A-Frame Digital Standee?",
    a: "An A-Frame Digital Standee is a freestanding A-frame digital signage unit used to display videos, images, promotional campaigns and business information in customer-facing spaces.",
  },
  {
  ...
  {
    q: "Can the A-Frame Digital Standee be customized?",
...
export default function AFrameDigitalStandeePage() {
    ...
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          ...
          alt="A-Frame Digital Standee by BrainADZ Live"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-4 lg:min-h-135 lg:px-12">
          <div className="flex items-center gap-3 text-[16px] font-light md:text-[18px]">
            ...
            <span className="text-white/80">/</span>
            <span className="text-white/90">A-Frame Digital Standee</span>
          </div>

          <div className="mt-12 max-w-205 md:mt-14">
            <h1 className="text-[38px] font-semibold leading-[1.15] tracking-[-1.2px] text-white md:text-[48px] lg:text-[56px]">
              A-Frame Digital Standee for Dynamic Brand Communication
            </h1>
          </div>

          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              A freestanding A-frame digital standee unit for displaying
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="max-w-170 text-[34px] font-normal leading-[1.15] tracking-[-1px] md:text-[46px]">
              A digital A-Frame standee built for visible, screen-based
              communication.
            </h2>

            <p className="mt-6 max-w-165 text-[16px] font-light leading-[1.75] text-black/70">
              The BrainADZ Live A-Frame Digital Standee is a freestanding digital
            ...
            {[
              ...
              <div key={label} className="text-center">
                <div className="overflow-hidden rounded-[20px] bg-[#f6f8fc] shadow-[0_22px_65px_rgba(0,0,0,0.06)]">
                  <img
                    src={src}
                    alt={`A-Frame Digital Standee ${label}`}
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-160 text-[16px] font-light leading-[1.7] text-black/65">
              BrainADZ Live plans the A-Frame Digital Standee based on its
        ...
        <div className="mx-auto max-w-450 px-4 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#193175] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                src="/CTA/cta.webp"
                alt="A-Frame Digital Standee deployment showcase"
                loading="lazy"
                decoding="async"
            ...
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-150">
                <h3 className="text-[20px] font-semibold leading-tight text-white md:text-[26px] lg:text-[30px]">
                  Planning an A-Frame Digital Standee deployment?
                </h3>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 text-center">
            ...
            <h2 className="mx-auto max-w-230 text-[34px] font-normal leading-[1.15] tracking-[-1px] md:text-[46px]">
              Common questions about A-Frame Digital Standee.
            </h2>
          </div>
          ...
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#193175] md:min-h-75">
            ...
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-150">
                ...
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Plan an A-Frame Digital Standee with the right content setup,
