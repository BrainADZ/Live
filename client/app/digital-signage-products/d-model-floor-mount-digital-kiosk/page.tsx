...
const faqs = [
  {
    q: "What is a D-Model Floor Mount Digital Kiosk?",
    a: "A D-Model Floor Mount Digital Kiosk is a freestanding digital signage unit used to display videos, images, promotional campaigns and business information in customer-facing spaces.",
  },
  {
  ...
  {
    q: "Can the D-Model Floor Mount Digital Kiosk be customized?",
...
export default function DModelFloorMountDigitalKioskPage() {
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/hero/d-type.webp"
          alt="D-Model Floor Mount Digital Kiosk by BrainADZ Live"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-4 lg:min-h-135 lg:px-12">
          <div className="flex items-center gap-3 text-[16px] font-light md:text-[18px]">
            ...
            <span className="text-white/90">D-Model Floor Mount Digital Kiosk</span>
          </div>

          <div className="mt-12 max-w-205 md:mt-14">
            <h1 className="text-[38px] font-semibold leading-[1.15] tracking-[-1.2px] text-white md:text-[48px] lg:text-[56px]">
              D-Model Floor Mount Digital Kiosk for Dynamic Business Communication
            </h1>
          </div>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-165 text-[16px] font-light leading-[1.75] text-black/70">
              The BrainADZ Live D-Model Floor Mount Digital Kiosk is a screen-based
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ["/overview/d-model-standee2.webp", "Right Side View"],
              ["/overview/d-model-standee1.webp", "Front View"],
              ["/overview/d-model-standee3.webp", "Left Side View"],
            ].map(([src, label]) => (
              <div key={label} className="text-center">
                <div className="overflow-hidden rounded-[20px] bg-[#f6f8fc] shadow-[0_22px_65px_rgba(0,0,0,0.06)]">
                  <img
                    src={src}
                    alt={`D-Model Floor Mount Digital Kiosk ${label}`}
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-160 text-[16px] font-light leading-[1.7] text-black/65">
              BrainADZ Live plans the D-Model Floor Mount Digital Kiosk based on its
        ...
        <div className="mx-auto max-w-450 px-4 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#193175] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                src="/CTA/cta.webp"
                alt="D-Model Floor Mount Digital Kiosk deployment showcase"
                loading="lazy"
                decoding="async"
          ...
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#193175] md:min-h-75">
            ...
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-150">
                ...
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Plan a D-Model Floor Mount Digital Kiosk with the right content setup,
