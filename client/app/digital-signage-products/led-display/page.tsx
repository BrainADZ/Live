...
const benefits = [
  {
    ...
    text: "Present promotional and informational content through a visible LED display format designed around the space and communication requirement.",
  },
  {
...
const specifications = [
  [
    "Display Type",
    "LED display solution for large-format digital communication",
  ],
  [
    "Content Support",
...
const faqs = [
  {
    q: "What is an LED Display?",
    a: "An LED Display is a digital visual communication solution used to present videos, images, promotional campaigns, announcements and business information in a larger display format.",
  },
  {
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-8 lg:min-h-135 lg:px-12">
          ...
          <div className="mt-12 max-w-205 md:mt-14">
            <h1 className="text-[38px] font-semibold leading-[1.15] tracking-[-1.2px] text-white md:text-[48px] lg:text-[56px]">
              LED Display Solutions for Large-Format Visual Communication
            </h1>
          </div>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live LED Display solutions are planned for businesses
          ...
          <div className="relative overflow-hidden bg-[#f6f8fc] shadow-[0_24px_80px_rgba(0,0,0,0.08)]">
            <img
              ...
              alt="LED Display for large-format visual communication"
          ...
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#193175] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                ...
                alt="LED Display solution showcase"
                loading="lazy"
                decoding="async"
                className="h-full w-full object-cover"
              />
