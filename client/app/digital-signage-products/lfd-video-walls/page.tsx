...
const faqs = [
  {
    q: "What are LFD Video Walls?",
    a: "LFD Video Walls use large-format screens to create visual solutions for digital signage, presentations, announcements and business communication.",
  },
  {
  ...
  {
    q: "Can LFD Video Walls be used for both digital signage and presentations?",
...
export default function LFDVideoWallsPage() {
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/hero/LFD.webp"
          alt="LFD Video Walls by BrainADZ Live"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-4 lg:min-h-135 lg:px-12">
          <div className="flex items-center gap-3 text-[16px] font-light md:text-[18px]">
            ...
            <span className="text-white/90">LFD Video Walls</span>
          </div>

          <div className="mt-12 max-w-205 md:mt-14">
            <h1 className="text-[38px] font-semibold leading-[1.15] tracking-[-1.2px] text-white md:text-[48px] lg:text-[56px]">
              LFD Video Walls for Digital Signage
            </h1>
          </div>

          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              LFD Video Wall solutions for presenting videos, images,
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live LFD Video Walls are large-format screen solutions
