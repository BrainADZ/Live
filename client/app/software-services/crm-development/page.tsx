...
const crmProcess = [
  {
    title: "CRM Discovery",
    text: "We understand your sales process, customer journey, teams, lead sources and reporting needs.",
    icon: Search,
  },
  {
    title: "Workflow Mapping",
    text: "We map lead stages, follow-ups, tasks, approvals, notifications and customer touchpoints.",
    icon: Workflow,
  },
  {
    title: "CRM Architecture",
    text: "We plan modules, roles, data structure, integrations, dashboards and automation logic.",
    icon: Network,
  },
  {
    title: "CRM Development",
    text: "We build lead management, sales pipeline, customer profiles, reports and admin controls.",
    icon: Code2,
  },
  {
    title: "Testing & Training",
    text: "We test workflows, permissions, data accuracy and train your team to use the CRM effectively.",
    icon: UserCheck,
  },
  {
    title: "Launch & Optimization",
    text: "We deploy the CRM, monitor usage, improve workflows and add new features as your team grows.",
    icon: Rocket,
  },
];
...
const overviewHighlights = [
  {
    ...
    text: "Track leads, sources, status, owners and follow-ups in one place.",
    icon: Target,
  },
  {
    title: "Sales Automation",
    text: "Automate reminders, tasks, assignments, emails and pipeline updates.",
    icon: BellRing,
  },
  {
    title: "Customer Insights",
    text: "View complete customer history, interactions, deals and communication.",
    icon: UsersRound,
  },
  {
    title: "Business Reports",
    text: "Get real-time reports for sales, team performance and conversion tracking.",
...
const crmModules = [
  {
    ...
    text: "Capture, assign, qualify and track leads from multiple channels.",
    icon: Target,
  },
  {
    title: "Sales Pipeline",
    text: "Manage deal stages, follow-ups, activities and conversion progress.",
    icon: BarChart3,
  },
  {
    title: "Customer Profiles",
    text: "Store customer details, notes, activities, purchase history and documents.",
    icon: UserCheck,
  },
  {
    title: "Task Automation",
    text: "Automate reminders, team tasks, lead routing and recurring actions.",
...
const integrations = [
  ...
  { title: "Payment Systems", icon: BriefcaseBusiness },
  { title: "ERP / Billing", icon: Boxes },
...
const caseStudies = [
  {
    ...
    text: "A CRM for lead tracking, customer follow-ups, sales pipeline and store-level reporting.",
    image: "/services/hero/Retail-CRM-and-Campaign-Management-System.png",
  },
  {
    title: "Education Admission CRM",
    text: "A centralized system for enquiries, counsellor follow-ups, admissions and conversion reports.",
    image: "/services/hero/education-crm.jpeg",
  },
  {
    title: "Real Estate CRM",
    text: "A CRM for property leads, site visits, broker coordination, reminders and deal management.",
    image: "/services/hero/real-estate-crm.jpeg",
  },
  {
    title: "Service Business CRM",
    text: "A customer management platform for tickets, renewals, tasks, service history and reports.",
...
const whyChoose = [
  {
    ...
    text: "We do not force a fixed CRM template. Your CRM is planned around your actual workflow.",
  },
  {
    title: "Role-Based Access",
    text: "Sales, managers, admins and support teams get the right permissions and visibility.",
  },
  {
    title: "Automation-Ready System",
    text: "We reduce manual follow-ups with reminders, notifications, triggers and smart assignments.",
  },
  {
    title: "Reports That Matter",
    text: "Your dashboard focuses on practical numbers like lead source, conversions and team activity.",
  },
];

const supportItems = [
  "CRM user training and onboarding",
  "Workflow improvements based on team feedback",
  "Performance monitoring and bug fixing",
  "New modules, reports and automation updates",
...
const faqs = [
  {
    ...
    a: "Custom CRM development means building a CRM around your sales process, customer journey, team roles, reporting needs and integrations instead of using a fixed ready-made system.",
  },
  {
    q: "Can you build CRM for sales teams?",
    a: "Yes. We build CRM systems for lead management, sales pipeline, follow-ups, task assignment, customer communication and performance reporting.",
  },
  {
    q: "Can CRM integrate with WhatsApp, email or ERP?",
    a: "Yes. We can integrate CRM with WhatsApp, SMS, email, payment gateways, ERP, billing systems, websites, forms and other third-party APIs.",
  },
  {
    q: "Can you migrate data from our existing CRM?",
    a: "Yes. We can help migrate leads, customers, activities and important records from spreadsheets or existing CRM platforms depending on data structure.",
  },
  {
    q: "Do you provide CRM support after launch?",
    a: "Yes. We provide training, bug fixing, feature improvements, reporting updates, workflow changes and ongoing technical support.",
  },
];
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/services/hero/crm-development.jpg"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-8 lg:min-h-135 lg:px-12">
          ...
          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              Custom CRM systems for lead management, sales automation,
              customer tracking, reporting and connected business workflows.
            </p>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
          <div>
            ...
            <h2 className="max-w-170 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              CRM software built around your customers, sales team and growth.
            </h2>
            <p className="mt-6 max-w-165 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live builds custom CRM platforms that help businesses
              manage leads, follow-ups, sales pipelines, customer records,
              reports and team activity from one connected system.
            </p>
          </div>
          ...
          <div className="mb-14 grid gap-8 lg:grid-cols-[0.78fr_1.22fr] lg:items-end">
            <div>
              ...
              <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Core CRM features your team can use every day.
              </h2>
            </div>
            <p className="max-w-185 text-[16px] font-light leading-[1.7] text-black/65">
              We keep the CRM practical, clean and focused on the activities
              that actually help your team close deals and serve customers.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {crmModules.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group rounded-[28px] border border-black/10 bg-white p-7 shadow-[0_18px_55px_rgba(0,0,0,0.04)] transition hover:-translate-y-1 hover:border-[#3C5B9B]/30 hover:shadow-[0_26px_75px_rgba(60,91,155,0.1)]"
                >
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="relative z-10 mx-auto mb-12 max-w-[1180px] text-center lg:mb-14">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] text-black md:text-[46px] lg:text-[54px]">
              Our CRM development roadmap
            </h2>
            <p className="mx-auto mt-5 max-w-[980px] text-[16px] font-light leading-[1.7] text-black/65 md:text-[20px]">
              A connected process to transform your sales workflow into a
              useful, secure and scalable CRM platform.
            </p>
          </div>
          ...
          <div className="relative hidden h-[790px] lg:block">
            <svg className="pointer-events-none absolute inset-0 z-0 h-full w-full" viewBox="0 0 1600 790" fill="none" aria-hidden="true" preserveAspectRatio="none">
              <defs>
                <marker id="crm-process-arrowhead" markerHeight="14" markerUnits="userSpaceOnUse" markerWidth="18" orient="auto" refX="16" refY="7">
                  <path d="M 0 0 L 18 7 L 0 14 z" fill="#3C5B9B" />
                </marker>
              </defs>
              <path d="M 392 43 L 1208 43" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#crm-process-arrowhead)" />
              ...
              <path d="M 1208 343 L 392 343" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#crm-process-arrowhead)" />
              <path d="M 306 343 C 118 343 78 468 102 535 C 126 598 205 613 306 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#crm-process-arrowhead)" />
              <path d="M 392 613 L 1208 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#crm-process-arrowhead)" />
            </svg>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:items-center">
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Manage the complete journey from first enquiry to repeat customer.
            </h2>
            <p className="mt-5 max-w-160 text-[16px] font-light leading-[1.7] text-black/65">
              A good CRM should not only store contacts. It should help your
              team understand every stage of the customer journey and take the
          ...
          <div className="grid gap-x-10 gap-y-7 md:grid-cols-2">
            {lifecycle.map((item, index) => (
              <div key={item} className="flex items-center gap-5 border-b border-black/10 pb-6">
                <div className="flex h-13 w-13 shrink-0 items-center justify-center rounded-full bg-[#3C5B9B]/10 text-[13px] font-semibold text-[#3C5B9B]">
                  0{index + 1}
                </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-220 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Connect your CRM with the tools your business already uses.
            </h2>
          </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-6">
            {integrations.map((item) => {
              const Icon = item.icon;
              return (
                <div key={item.title} className="border-t border-black/10 bg-white/50 pt-7 text-center">
                  <Icon size={30} className="mx-auto mb-4 text-[#3C5B9B]" />
          ...
          <div className="mb-14 flex flex-col justify-between gap-7 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="max-w-195 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                CRM solutions built for sales, service and customer operations.
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-210 text-[38px] font-light leading-[1.1] tracking-[-1.7px] text-[#262626] md:text-[48px] lg:text-[54px]">
              Technologies powering custom CRM development
            </h2>
            <p className="mx-auto mt-6 max-w-220 text-[17px] font-light leading-[1.75] tracking-[-0.2px] text-[#525252] md:text-[19px]">
              ...
              technologies to build secure, scalable and automation-ready CRM
              platforms.
            </p>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              We build CRM systems that teams actually use.
            </h2>
          </div>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div className="overflow-hidden bg-[#f6f8fc] shadow-[0_24px_80px_rgba(0,0,0,0.08)]">
            <img src="/services/hero/crm-support.jpg" alt="CRM support and optimization" className="h-full w-full object-cover" />
          </div>
          <div>
            <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.18em] text-[#3C5B9B]">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              A CRM becomes valuable when your team keeps improving with it.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.7] text-black/65">
              After launch, we help your team use the CRM better with training,
              workflow improvements, monitoring and continuous enhancements.
            </p>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto max-w-450">
          ...
          <div className="grid gap-4 lg:grid-cols-2 lg:gap-5">
            {faqs.map((faq, index) => (
              <div key={faq.q} className={`group overflow-hidden rounded-[26px] border bg-white transition-all duration-300 ${openFaq === index ? "border-[#3C5B9B]/35 shadow-[0_22px_70px_rgba(60,91,155,0.12)]" : "border-black/10 shadow-[0_12px_42px_rgba(0,0,0,0.035)] hover:border-[#3C5B9B]/25"}`}>
        ...
        <div className="mx-auto max-w-450 px-8 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#3C5B9B] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img src="/about.avif" alt="BrainADZ Live CRM Development" loading="lazy" decoding="async" className="h-full w-full object-cover" />
            </div>
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-150">
                ...
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Let BrainADZ Live create a custom CRM for leads, sales,
                  customers, automation and business reporting.
                </p>
              </div>
