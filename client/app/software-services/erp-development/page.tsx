...
const processSteps = [
  {
    title: "ERP Discovery",
    text: "We study your departments, approval flows, reports, users, existing tools and operational bottlenecks.",
    icon: Search,
  },
  {
    title: "Module Planning",
    text: "We define ERP modules, permissions, data flow, integrations and the right implementation roadmap.",
    icon: Layers3,
  },
  {
    title: "Architecture Design",
    text: "We plan a secure and scalable ERP foundation for users, data, workflows, reports and future growth.",
    icon: Box,
  },
  {
    title: "ERP Development",
    text: "We build custom modules, dashboards, business logic, APIs, approvals and automation workflows.",
    icon: Code2,
  },
  {
    title: "Testing & Migration",
    text: "We test workflows, migrate clean data, validate reports and prepare your teams for smooth adoption.",
    icon: ShieldCheck,
  },
  {
    title: "Launch & Optimization",
    text: "We deploy the ERP, monitor performance, support users and continuously improve modules after launch.",
    icon: RocketIcon,
  },
];
...
const erpModules = [
  ...
  { title: "Sales & CRM", icon: LineChart },
  { title: "Purchase Management", icon: ShoppingCart },
...
const services = [
  {
    ...
    text: "ERP software built around your exact departments, approvals, data and business processes.",
    icon: Building2,
  },
  {
    title: "ERP Module Development",
    text: "Finance, inventory, HR, sales, purchase, production and reporting modules for daily operations.",
    icon: Layers3,
  },
  {
    title: "ERP Integration",
    text: "Connect ERP with CRM, ecommerce, payment gateways, accounting tools, HR systems and APIs.",
    icon: GitBranch,
  },
  {
    title: "ERP Modernization",
    text: "Upgrade outdated ERP systems with better UI, faster workflows, secure architecture and cloud readiness.",
    icon: RefreshCcw,
  },
];
...
const caseStudies = [
  {
    ...
    text: "A centralized ERP for production, inventory, purchase, dispatch and operational visibility.",
    image: "/services/hero/download.jpeg",
  },
  {
    title: "Retail Operations ERP",
    text: "A connected ERP system for sales, stock, billing, customer data and branch-level reporting.",
    image: "/services/hero/Retail-CRM-and-Campaign-Management-System.png",
  },
  {
    title: "Finance Reporting Platform",
    text: "Role-based dashboards for finance, approvals, expenses, revenue tracking and reports.",
    image: "/services/hero/serviceadmin.jpeg",
  },
  {
    title: "Logistics ERP Dashboard",
    text: "ERP tools for shipments, fleet activity, warehouse data, delivery tracking and team coordination.",
...
const whyChoose = [
  {
    ...
    text: "We study how your departments actually work before designing ERP modules and workflows.",
  },
  {
    title: "Scalable ERP Architecture",
    text: "Your ERP is planned for more users, more branches, more data and future integrations.",
  },
  {
    title: "Secure Access Control",
    text: "Role-based access, protected data, approvals and audit-friendly workflows keep operations safe.",
  },
  {
    title: "Long-Term ERP Support",
    text: "We support your ERP with improvements, training, updates, monitoring and new modules.",
  },
];

const supportItems = [
  "Performance monitoring and uptime checks",
  "Security patches and access control improvements",
  "New module development as your business grows",
  "User support, training and workflow improvements",
  "Backup planning, data recovery and report optimization",
];
...
const faqs = [
  {
    ...
    a: "We build custom ERP systems for finance, inventory, sales, purchase, HR, manufacturing, logistics, reporting and multi-branch operations.",
  },
  {
    q: "Can you customize ERP according to our business process?",
    a: "Yes. We design ERP modules around your existing workflows, approval process, departments, users and reporting needs.",
  },
  {
    q: "Can you integrate ERP with our existing systems?",
    a: "Yes. We can integrate ERP with CRM, ecommerce platforms, accounting software, payment gateways, HR tools, APIs and third-party systems.",
  },
  {
    q: "Can you migrate data from our old ERP or spreadsheets?",
    a: "Yes. We can clean, map and migrate existing data from legacy ERP systems, spreadsheets or databases into the new ERP platform.",
  },
  {
    q: "Do you provide ERP support after launch?",
    a: "Yes. We provide support, maintenance, monitoring, user training, bug fixing, module upgrades and performance improvements.",
  },
];
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/services/hero/erp-development.jpg"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-8 lg:min-h-135 lg:px-12">
          ...
          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              Custom ERP systems that connect departments, automate workflows,
              improve reporting and give your business better operational
              control.
            </p>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="max-w-180 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              ERP software built to connect people, process and data.
            </h2>

            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live builds ERP solutions that bring your business
              operations into one connected system. From finance and inventory
              to HR, purchase, sales and reporting, we create ERP platforms that
              improve visibility and reduce manual work.
            </p>
          </div>
            ...
            {[
              {
                ...
                text: "Bring departments, data and approvals into one reliable system.",
                icon: Workflow,
              },
              {
                title: "Better Business Visibility",
                text: "Track reports, performance, inventory, finance and teams in real time.",
                icon: BarChart3,
              },
              {
                title: "Secure User Access",
                text: "Control permissions with role-based access and approval workflows.",
                icon: LockKeyhole,
              },
              {
                title: "Scalable ERP Foundation",
                text: "Build ERP modules that grow with users, branches and business needs.",
                icon: Gauge,
              },
            ].map((item) => {
              ...
              return (
                <div key={item.title} className="border-l-2 border-[#3C5B9B] pl-5">
                  <Icon size={26} className="mb-4 text-[#3C5B9B]" />
          ...
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
            <div>
              ...
              <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Common problems ERP solves for growing businesses.
              </h2>
            </div>

            <p className="max-w-185 text-[16px] font-light leading-[1.7] text-black/65">
              Many businesses still depend on scattered spreadsheets, manual
              approvals and disconnected tools. A custom ERP helps replace this
              with structured workflows and accurate data.
            </p>
          </div>

          <div className="grid gap-x-12 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              "Disconnected departments and repeated data entry",
              "Manual approvals that delay daily operations",
              "Limited visibility across finance, stock and teams",
              "Difficult reporting due to scattered business data",
            ].map((item, index) => (
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-220 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              ERP solutions designed around your business workflow.
            </h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {services.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group rounded-[28px] border border-black/10 bg-white p-7 shadow-[0_18px_55px_rgba(0,0,0,0.04)] transition duration-300 hover:-translate-y-1 hover:border-[#3C5B9B]/35 hover:shadow-[0_28px_80px_rgba(60,91,155,0.1)]"
                >
                  <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#3C5B9B]/10 transition group-hover:bg-[#3C5B9B]">
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="relative z-10 mx-auto mb-12 max-w-[1180px] text-center lg:mb-14">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] text-black md:text-[46px] lg:text-[54px]">
              Our connected ERP implementation roadmap
            </h2>
            <p className="mx-auto mt-5 max-w-[980px] text-[16px] font-light leading-[1.7] text-black/65 md:text-[20px]">
              We follow a structured ERP development process to reduce risk,
              improve adoption and deliver a system your teams can use every day.
            </p>
          </div>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Core ERP modules we can build for your business.
            </h2>
            <p className="mt-5 max-w-150 text-[16px] font-light leading-[1.7] text-black/65">
              Choose only the modules you need today and expand your ERP as your
              business grows.
            </p>
          </div>
            ...
            {erpModules.map((item, index) => {
              ...
              return (
                <div key={item.title} className="group flex items-center gap-5 border-b border-black/10 pb-6">
                  <div className="flex h-13 w-13 shrink-0 items-center justify-center rounded-full bg-[#3C5B9B]/10 text-[#3C5B9B] transition group-hover:bg-[#3C5B9B] group-hover:text-white">
                    <Icon size={23} />
                  </div>
                  <div>
                    <span className="text-[12px] font-semibold text-[#3C5B9B]">
                      0{index + 1}
                    </span>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="relative overflow-hidden bg-white p-7 shadow-[0_24px_80px_rgba(0,0,0,0.06)] md:p-10">
            <div className="mb-8 flex items-center justify-between gap-5 border-b border-black/10 pb-5">
              <div>
                <p className="text-[13px] font-semibold uppercase tracking-[0.18em] text-[#3C5B9B]">
                  ERP Flow
                </p>
                <h3 className="mt-2 text-[30px] font-light tracking-[-0.7px]">
                  One system. Multiple departments.
                </h3>
              </div>
              <Database size={38} className="text-[#3C5B9B]" />
            </div>
            ...
            <div className="my-7 flex items-center justify-center">
              <ArrowRight className="rotate-90 text-[#3C5B9B]" size={30} />
            </div>

            <div className="bg-[#3C5B9B] px-6 py-5 text-center text-[18px] font-light text-white">
          ...
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Replace scattered tools with one connected ERP ecosystem.
            </h2>
            <p className="mt-6 text-[16px] font-light leading-[1.75] text-black/65">
              A custom ERP gives every department access to the right data at
              the right time. Teams can manage operations, approvals, documents,
              reports and performance from a centralized system.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mb-14 flex flex-col justify-between gap-7 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="max-w-195 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                ERP solutions built for practical business operations.
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-210 text-[38px] font-light leading-[1.1] tracking-[-1.7px] text-[#262626] md:text-[48px] lg:text-[54px]">
              Technologies powering custom ERP development
            </h2>
            <p className="mx-auto mt-6 max-w-220 text-[17px] font-light leading-[1.75] tracking-[-0.2px] text-[#525252] md:text-[19px]">
              ...
              systems that are secure, scalable and easy to maintain.
            </p>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              ERP development focused on usability, control and growth.
            </h2>
            <p className="mt-5 max-w-150 text-[16px] font-light leading-[1.7] text-black/65">
              We build ERP systems that are practical for your team, secure for
              your data and flexible for future expansion.
            </p>
          </div>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              ERP support that continues after launch.
            </h2>
            <div className="mt-8 space-y-5">
              {supportItems.map((item) => (
                <div key={item} className="flex gap-4 border-b border-black/10 pb-5">
                  <CheckCircle2 size={24} className="mt-1 shrink-0 text-[#3C5B9B]" />
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto max-w-450">
          ...
          <div className="grid gap-4 lg:grid-cols-2 lg:gap-5">
            {faqs.map((faq, index) => (
              <div key={faq.q} className={`group overflow-hidden rounded-[26px] border bg-white transition-all duration-300 ${openFaq === index ? "border-[#3C5B9B]/35 shadow-[0_22px_70px_rgba(60,91,155,0.12)]" : "border-black/10 shadow-[0_12px_42px_rgba(0,0,0,0.035)] hover:-translate-y-1 hover:border-[#3C5B9B]/25"}`}>
                <button type="button" aria-expanded={openFaq === index} onClick={() => setOpenFaq(openFaq === index ? -1 : index)} className="flex w-full items-center justify-between gap-5 px-5 py-5 text-left md:px-6">
                  <span className="flex items-center gap-4">
                    <span className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-[13px] font-semibold transition duration-300 ${openFaq === index ? "bg-[#3C5B9B] text-white" : "bg-[#3C5B9B]/10 text-[#3C5B9B]"}`}>
                  ...
                  <span className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full transition duration-300 ${openFaq === index ? "bg-[#3C5B9B] text-white" : "bg-[#f6f8fc] text-[#3C5B9B]"}`}>
        ...
        <div className="mx-auto max-w-450 px-8 lg:px-10">
          <div className="flex min-h-65 overflow-hidden bg-[#3C5B9B] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img src="/about.avif" alt="BrainADZ Live ERP Development" loading="lazy" decoding="async" className="h-full w-full object-cover" />
            </div>
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-150">
                <h3 className="text-[20px] font-semibold leading-tight text-white md:text-[26px] lg:text-[30px]">
                  Ready to build a custom ERP for your business?
                </h3>
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Let BrainADZ Live create an ERP system that connects your
                  teams, data, workflows and business growth.
                </p>
              </div>
