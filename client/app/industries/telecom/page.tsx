...
const workflow = [
  {
    title: "Telecom Workflow Discovery",
    text: "We understand your telecom operations, customer journeys, service plans, network workflows, support process and digital goals.",
    icon: Search,
  },
  {
    title: "Telecom Architecture Planning",
    text: "We plan customer portals, plan management, network dashboards, billing flows, support systems and cloud infrastructure.",
    icon: Layers3,
  },
  {
    title: "UI/UX & Prototype",
    text: "We design clean customer portals, admin dashboards, support panels and network monitoring interfaces.",
    icon: MonitorSmartphone,
  },
  {
    title: "Secure Telecom Development",
    text: "We build telecom modules for customers, subscriptions, plans, billing, tickets, network visibility, alerts and reporting.",
    icon: Code2,
  },
  {
    title: "Network & System Integration",
    text: "We integrate payment gateways, CRMs, ERPs, network tools, APIs, notifications and third-party telecom systems.",
    icon: Workflow,
  },
  {
    title: "Testing & Optimization",
    text: "We test billing flows, user roles, network dashboards, support workflows, data security and platform reliability.",
    icon: ShieldCheck,
  },
  {
    title: "Cloud Deployment",
    text: "We deploy your telecom platform on reliable cloud infrastructure with monitoring, backup and scalability setup.",
    icon: Rocket,
  },
  {
    title: "Support & Maintenance",
    text: "We provide updates, monitoring, issue fixing, security improvements and new telecom feature enhancements.",
    icon: LifeBuoy,
  },
];
...
const telecomBenefits = [
  {
    ...
    text: "Monitor services, users, plans, tickets and network activity through real-time dashboards.",
    icon: Signal,
  },
  {
    title: "Faster Service Delivery",
    text: "Manage activations, service requests, billing, support and customer communication from one platform.",
    icon: Rocket,
  },
  {
    title: "Better Customer Control",
    text: "Manage customers, subscriptions, usage, complaints, renewals and support workflows.",
    icon: Wifi,
  },
  {
    title: "Smarter Telecom Decisions",
    text: "Use analytics to improve customer experience, plan performance, support quality and revenue.",
    icon: BarChart3,
  },
];
...
const challenges = [
  {
    ...
    text: "Replace manual customer records, plan updates, support tickets and billing workflows with a connected platform.",
  },
  {
    title: "Limited Network Visibility",
    text: "Track service status, network issues, usage trends and customer requests in real time.",
  },
  {
    title: "Slow Support Resolution",
    text: "Improve ticket handling, issue tracking, SLA visibility and customer communication.",
  },
  {
    title: "Disconnected Telecom Operations",
    text: "Connect customers, sales, billing, support, field teams and admins in one workflow.",
  },
];
...
const solutions = [
  {
    ...
    text: "Manage customers, leads, plans, renewals, complaints, service requests and communication from one dashboard.",
    icon: Wifi,
  },
  {
    title: "Customer Self-Service Portal",
    text: "Let customers manage plans, payments, support tickets, invoices, usage and service requests.",
    icon: RadioTower,
  },
  {
    title: "Network Monitoring Dashboard",
    text: "Monitor service status, outage reports, network performance, alerts and issue resolution.",
    icon: Network,
  },
  {
    title: "Field Service App",
    text: "Give field teams installation tasks, customer details, service updates, route notes and completion reports.",
    icon: Users,
  },
  {
    title: "Billing & Subscription System",
    text: "Manage prepaid, postpaid, recurring billing, invoices, renewals, payments and plan upgrades.",
    icon: Server,
  },
  {
    title: "Telecom Analytics Platform",
    text: "Analyze customers, churn, revenue, support tickets, usage patterns and service performance.",
    icon: BarChart3,
  },
];
...
const telecomTypes = [
  {
    ...
    text: "We build telecom CRM platforms for customer onboarding, plan management, renewals, service requests, complaints, sales tracking and communication.",
    icon: Wifi,
  },
  {
    title: "Customer Self-Service Portals",
    text: "Our self-service portals allow customers to manage subscriptions, invoices, payments, tickets, service requests, usage details and plan upgrades.",
    icon: Server,
  },
  {
    title: "Billing & Subscription Platforms",
    text: "We build billing systems for recurring plans, prepaid/postpaid models, invoices, renewals, payments, upgrades and customer account management.",
    icon: RadioTower,
  },
  {
    title: "Network Monitoring Solutions",
    text: "We develop dashboards for network health, outages, service alerts, performance metrics and faster issue resolution.",
    icon: Network,
  },
  {
    title: "Field Service Management",
    text: "We create field service systems for installations, site visits, service tasks, customer locations, technician updates and completion tracking.",
    icon: Users,
  },
  {
    title: "Telecom Analytics Dashboards",
    text: "We build dashboards for customer growth, churn, ticket volume, revenue, plan performance, support quality and network insights.",
    icon: BarChart3,
  },
];
...
const caseStudies = [
  {
    title: "Telecom CRM Platform",
    text: "A telecom CRM for customer onboarding, plans, service tickets, renewals, communication and reporting.",
    image: "/industries/telecom/telecom-crm.jpg",
  },
  {
    title: "Network Monitoring Dashboard",
    text: "A real-time network dashboard for outages, alerts, service status, performance metrics and issue resolution.",
    image: "/industries/telecom/network-monitoring.jpg",
  },
  {
    title: "Customer Billing Portal",
    text: "A customer portal with invoices, plan details, payments, upgrades, renewals and support requests.",
    image: "/industries/telecom/billing-portal.jpg",
  },
  {
    title: "Telecom Analytics Dashboard",
    text: "An analytics dashboard for revenue, churn, support tickets, customer growth and network performance.",
...
const whyChoose = [
  {
    title: "Telecom Workflow Understanding",
    text: "We design platforms around real telecom workflows, customer journeys, billing, support and field operations.",
  },
  {
    title: "Scalable Telecom Architecture",
    text: "We build systems that support customer scale, recurring billing, service tickets, dashboards and integrations.",
  },
  {
    title: "Custom Development",
    text: "Your telecom platform is built according to your service plans, users, workflows and business model.",
  },
  {
...
const supportItems = [
  "Telecom platform monitoring",
  "New telecom modules and features",
...
const faqs = [
  {
    q: "Do you build telecom management software?",
    a: "Yes, we build custom telecom management platforms for fleets, logistics, passenger telecom, delivery businesses and mobility startups.",
  },
  {
    q: "Can you build fleet management systems?",
    a: "Yes, we develop fleet management systems with vehicle tracking, driver management, route planning, maintenance alerts and reporting.",
  },
  {
    q: "Can you integrate Network monitoring?",
    a: "Yes, we can integrate Network monitoring, live route maps, trip status, vehicle movement and location-based notifications.",
  },
  {
    q: "Do you build driver mobile apps?",
    a: "Yes, we can build driver apps with trip details, route guidance, status updates, delivery proof, payment details and notifications.",
  },
  {
    q: "Can you create logistics tracking dashboards?",
    a: "Yes, we create logistics dashboards for shipment tracking, delivery updates, route status, driver performance and customer communication.",
  },
  {
    q: "Can the platform support multiple branches?",
    a: "Yes, we can build multi-branch telecom platforms with branch-wise fleet data, centralized admin access and reporting.",
  },
  {
    q: "Can payment systems be integrated?",
    a: "Yes, we can integrate payment gateways, invoice management, customer billing, driver payments and subscription-based billing flows.",
  },
  {
  ...
  },
  {
    ...
    a: "Timeline depends on features, integrations, user roles, GPS requirements and platform complexity. A basic system can take a few weeks, while advanced platforms need more time.",
  },
];
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/industries/telecom/telecom-hero.jpg"
          alt="Telecom Software Solutions"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-8 lg:min-h-135 lg:px-12">
          ...
          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              Smart, scalable and tracking-ready telecom platforms for fleets,
              logistics, passenger mobility, delivery operations and telecom businesses.
            </p>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="max-w-170 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Digital telecom systems built for visibility, speed and control.
            </h2>
            <p className="mt-6 max-w-165 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live helps telecom companies build custom platforms for
              fleet management, Network monitoring, booking, route planning, dispatch,
              driver management, payments and analytics.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Solving real operational problems in telecom.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-220 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Custom platforms for telecom operators, ISPs, support teams and service providers.
            </h2>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              A connected architecture for telecom operations.
            </h2>
            <p className="mt-5 max-w-165 text-[16px] font-light leading-[1.7] text-black/65">
              We plan telecom systems with connected modules for customers, plans, billing, support teams, field teams, network visibility and analytics.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="relative z-10 mx-auto mb-12 max-w-[1180px] text-center lg:mb-14">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] text-black md:text-[46px] lg:text-[54px]">
              Our telecom software development roadmap
            </h2>

            <p className="mx-auto mt-5 max-w-[980px] text-[16px] font-light leading-[1.7] text-black/65 md:text-[20px]">
              From telecom workflow discovery to secure deployment, we follow a clear zig-zag process to build platforms with better customer management, billing, support and scalability.
            </p>
          </div>
          ...
          <div className="relative hidden h-[1060px] lg:block">
            ...
            >
              ...
              <path d="M 392 43 L 1208 43" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#telecom-zigzag-arrow)" />
              ...
              <path d="M 1208 343 L 392 343" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#telecom-zigzag-arrow)" />
              <path d="M 306 343 C 118 343 78 468 102 535 C 126 598 205 613 306 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#telecom-zigzag-arrow)" />
              <path d="M 392 613 L 1208 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#telecom-zigzag-arrow)" />
              ...
              <path d="M 1208 913 L 392 913" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#telecom-zigzag-arrow)" />
            </svg>
        ...
        <div className="mx-auto grid max-w-450 gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <h2 className="max-w-175 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Types of telecom solutions we develop
            </h2>
            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70 md:text-[18px]">
              We create telecom systems for ISPs, service providers, network operators, support teams and digital telecom businesses.
            </p>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
            <div>
              ...
              <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Essential features for a complete telecom platform.
              </h2>
            </div>
            <p className="max-w-185 text-[16px] font-light leading-[1.7] text-black/65">
              We build telecom platforms with practical features for customers, sales teams, support agents, field teams, billing teams and admins.
            </p>
          </div>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Reliable telecom software for live service operations.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.75] text-black/65">
              Telecom platforms depend on accurate customer data, billing reliability and secure access. We focus on platform stability, protected APIs, user roles, backups and payment security.
            </p>
          </div>
          ...
          <div className="mb-14 flex flex-col justify-between gap-7 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="max-w-195 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Telecom platforms built for real operational improvement.
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-210 text-[38px] font-light leading-[1.1] tracking-[-1.7px] text-[#262626] md:text-[48px] lg:text-[54px]">
              Technologies powering smart telecom platforms
            </h2>
            <p className="mx-auto mt-6 max-w-220 text-[17px] font-light leading-[1.75] tracking-[-0.2px] text-[#525252] md:text-[19px]">
              ...
              to build telecom platforms with performance, billing reliability and scalability.
            </p>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              We build telecom platforms around customer experience, automation and growth.
            </h2>
          </div>
          <div className="grid gap-x-12 gap-y-8 md:grid-cols-2">
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative overflow-hidden bg-[#f6f8fc] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.08)]">
            <img
              ...
              alt="Telecom Support and Maintenance"
              className="h-full w-full object-cover"
            />
          </div>
          <div>
            <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.18em] text-[#3C5B9B]">
              Telecom Support & Growth
            </p>
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Support that keeps your telecom platform reliable.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.7] text-black/65">
              Telecom software needs continuous updates, billing improvements, monitoring and performance optimization. We support your platform after launch.
            </p>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 text-center">
            ...
            <h2 className="mx-auto max-w-230 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Common questions about telecom software development.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-450 px-8 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#3C5B9B] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                src="/about.avif"
                alt="BrainADZ Live Telecom Software"
                loading="lazy"
                decoding="async"
                className="h-full w-full object-cover"
              />
            ...
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-145">
                ...
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Let BrainADZ Live help you create a scalable, customer-focused and operations-ready telecom solution.
                </p>
              </div>
              <a
                href="/contact"
