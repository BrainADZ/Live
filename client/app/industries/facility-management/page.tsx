...
const workflow = [
  {
    title: "Facility Workflow Discovery",
    text: "We understand your facility operations, assets, maintenance, staff, service requests, inspections and management goals.",
    icon: Search,
  },
  {
    title: "Facility Architecture Planning",
    text: "We plan asset management, maintenance workflows, staff dashboards, service request flows, reporting, integrations and cloud infrastructure.",
    icon: Layers3,
  },
  {
    title: "UI/UX & Prototype",
    text: "We design clean facility dashboards, staff panels, service request screens, asset views and admin workflows.",
    icon: MonitorSmartphone,
  },
  {
    title: "Secure Platform Development",
    text: "We build core facility modules including assets, maintenance, work orders, staff, inspections, vendors, notifications and reporting.",
    icon: Code2,
  },
  {
    title: "System Integration",
    text: "We integrate ERPs, CRMs, IoT tools, access systems, vendor platforms, notifications, APIs and third-party facility systems.",
    icon: Workflow,
  },
  {
    title: "Testing & Security Review",
    text: "We test work orders, maintenance flows, user roles, asset data, notifications, reports, performance and data security.",
    icon: ShieldCheck,
  },
  {
    title: "Cloud Deployment",
    text: "We deploy your facility platform on reliable cloud infrastructure with monitoring, backup and scalability setup.",
    icon: Rocket,
  },
  {
    title: "Support & Maintenance",
    text: "We provide updates, monitoring, issue fixing, maintenance workflow improvements and new feature enhancements.",
    icon: LifeBuoy,
  },
];
...
const facilityBenefits = [
  {
    ...
    text: "Simplify service requests, work orders, task assignment, maintenance tracking and completion workflows.",
    icon: ClipboardCheck,
  },
  {
    title: "Better Asset Management",
    text: "Manage assets, equipment, locations, vendors, staff, inspections and maintenance schedules from one platform.",
    icon: Building2,
  },
  {
    title: "Improved Facility Experience",
    text: "Give occupants, clients and teams easy access to requests, updates, schedules and support.",
    icon: Users,
  },
  {
    title: "Smarter Facility Decisions",
    text: "Use reports and analytics to track assets, costs, requests, staff productivity and maintenance performance.",
    icon: BarChart3,
  },
];
...
const challenges = [
  {
    ...
    text: "Digitize maintenance requests, work orders, task updates, approvals and completion tracking.",
  },
  {
    title: "Disconnected Asset Data",
    text: "Bring asset, location, maintenance, vendor, inspection and staff data into one connected system.",
  },
  {
    title: "Slow Service Resolution",
    text: "Improve service request handling, task assignment, escalation, reminders and communication.",
  },
  {
    title: "Limited Facility Visibility",
    text: "Track assets, maintenance costs, staff activity, service requests and operational KPIs through dashboards.",
  },
];
...
const solutions = [
  {
    ...
    text: "Manage assets, equipment, locations, maintenance history, warranty details, vendors and lifecycle tracking from one dashboard.",
    icon: Building2,
  },
  {
    title: "Work Order Management System",
    text: "Digitize service requests, task assignment, priority tracking, approvals, progress updates and completion workflows.",
    icon: ClipboardCheck,
  },
  {
    title: "Service Request Portal",
    text: "Let occupants, clients and teams raise requests, track status, add details, upload images and receive updates.",
    icon: Users,
  },
  {
    title: "Staff & Vendor Portal",
    text: "Give staff and vendors tools for assigned tasks, schedules, updates, checklists, communication and completion reports.",
    icon: UserCheck,
  },
  {
    title: "Facility Cost Management",
    text: "Manage vendor bills, maintenance costs, budgets, invoices, approvals, receipts and facility expenses.",
    icon: WalletCards,
  },
  {
    title: "Facility Analytics Dashboard",
    text: "Analyze assets, requests, maintenance costs, staff productivity, vendor performance and facility KPIs.",
    icon: BarChart3,
  },
];
...
const facilityTypes = [
  {
    ...
    text: "We build asset management platforms for equipment, locations, maintenance history, warranties, depreciation, vendor details and lifecycle tracking.",
    icon: Building2,
  },
  {
    title: "Maintenance Management Systems",
    text: "Our maintenance platforms simplify service requests, work orders, task allocation, inspections, preventive maintenance and completion tracking.",
    icon: ClipboardCheck,
  },
  {
    title: "Service Request Portals",
    text: "We create request portals where occupants and clients can raise issues, track progress, attach images, receive updates and contact support.",
    icon: Users,
  },
  {
    title: "Staff & Vendor Platforms",
    text: "We build staff and vendor systems for schedules, assigned work, checklists, task updates, approvals and completion reports.",
    icon: UserCheck,
  },
  {
    title: "Facility Cost Solutions",
    text: "We develop cost systems for vendor billing, maintenance budgets, invoice approvals, expenses, receipts and cost reporting.",
    icon: CreditCard,
  },
  {
    title: "Facility Analytics Dashboards",
    text: "We build dashboards for maintenance trends, asset performance, vendor quality, request volume, cost control and operational insights.",
    icon: BarChart3,
  },
];
...
const caseStudies = [
  {
    ...
    text: "A facility platform for assets, maintenance history, locations, vendors, warranties and lifecycle tracking.",
    image: "/industries/facility-management/asset-management.jpg",
  },
  {
    title: "Work Order System",
    text: "A work order platform for service requests, task assignment, priorities, approvals and completion tracking.",
    image: "/industries/facility-management/work-order-system.jpg",
  },
  {
    title: "Vendor Portal",
    text: "A vendor portal for assigned tasks, schedules, updates, invoices, checklists and completion reports.",
    image: "/industries/facility-management/vendor-portal.jpg",
  },
  {
    title: "Facility Analytics Dashboard",
    text: "A dashboard for maintenance costs, asset performance, service requests, staff productivity and vendor quality.",
...
const whyChoose = [
  {
    title: "Facility Workflow Understanding",
    text: "We design platforms around real facility workflows including assets, maintenance, vendors, requests, approvals and reporting.",
  },
  {
    title: "Operations-Ready Architecture",
    text: "We build systems that support work orders, asset records, staff roles, vendors, approvals and analytics.",
  },
  {
    title: "Custom Development",
    text: "Your facility platform is built according to your locations, assets, teams, vendors and service model.",
  },
  {
...
const supportItems = [
  "Facility platform monitoring",
  "New maintenance and asset modules",
  "Performance and speed optimization",
  "Security updates and access improvements",
  "Dashboard, request and reporting upgrades",
];
...
const faqs = [
  {
    q: "Do you build custom facility management software?",
    a: "Yes, we build custom facility management platforms for assets, maintenance, work orders, vendors, staff, requests, costs and analytics.",
  },
  {
    q: "Can you build maintenance management software?",
    a: "Yes, we develop maintenance systems with service requests, work orders, task assignment, approvals, inspections and completion tracking.",
  },
  {
    q: "Can you create service request portals?",
    a: "Yes, we can build portals where occupants or clients can raise requests, track status, upload images and receive updates.",
  },
  {
    q: "Can you build staff or vendor portals?",
    a: "Yes, we create staff and vendor portals for tasks, schedules, checklists, updates, invoices and completion reports.",
  },
  {
    q: "Can cost and billing systems be integrated?",
    a: "Yes, we can integrate vendor billing, invoices, approvals, expense tracking, payment workflows and cost reports.",
  },
  {
  ...
  {
    q: "Can the software support multiple buildings or sites?",
    a: "Yes, we can build multi-site facility platforms with location-wise data, centralized admin access and role-based reporting.",
  },
  {
    q: "Can you integrate third-party facility tools?",
    a: "Yes, we can integrate ERPs, CRMs, IoT systems, access tools, vendor systems, notification tools and custom APIs.",
  },
  {
  ...
  {
    q: "How long does facility software development take?",
    a: "Timeline depends on features, integrations, user roles, locations, asset workflows and platform complexity. A basic platform can take a few weeks, while advanced systems need more time.",
  },
];
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/industries/facility-management/facility-management-hero.jpg"
          alt="Facility Management Software Solutions"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-8 lg:min-h-135 lg:px-12">
          <div className="flex items-center gap-3 text-[16px] font-light md:text-[18px]">
            ...
            <span className="text-white/80">/</span>
            <span className="text-white/90">Facility Management</span>
          </div>
          ...
          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              Secure, scalable and workflow-driven facility platforms for policy
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="max-w-170 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Digital facility systems built for speed, trust and control.
            </h2>
            <p className="mt-6 max-w-165 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live helps facility businesses build platforms for policy
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Solving real operational problems in facility management.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-220 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Custom platforms for buildings, assets, maintenance teams, vendors and facility operations.
            </h2>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              A connected architecture for facility operations.
            </h2>
            <p className="mt-5 max-w-165 text-[16px] font-light leading-[1.7] text-black/65">
              We plan facility systems with connected modules for assets, requests, staff, vendors, maintenance, inspections, costs and analytics.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="relative z-10 mx-auto mb-12 max-w-[1180px] text-center lg:mb-14">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] text-black md:text-[46px] lg:text-[54px]">
              Our facility management software development roadmap
            </h2>

            <p className="mx-auto mt-5 max-w-[980px] text-[16px] font-light leading-[1.7] text-black/65 md:text-[20px]">
              From facility workflow discovery to secure deployment, we follow a clear zig-zag process to build platforms with better maintenance, asset control and scalability.
            </p>
          </div>
          ...
          <div className="relative hidden h-[1060px] lg:block">
            ...
            >
              ...
              <path d="M 392 43 L 1208 43" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#facility-zigzag-arrow)" />
              ...
              <path d="M 1208 343 L 392 343" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#facility-zigzag-arrow)" />
              <path d="M 306 343 C 118 343 78 468 102 535 C 126 598 205 613 306 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#facility-zigzag-arrow)" />
              <path d="M 392 613 L 1208 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#facility-zigzag-arrow)" />
              ...
              <path d="M 1208 913 L 392 913" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#facility-zigzag-arrow)" />
            </svg>
        ...
        <div className="mx-auto grid max-w-450 gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70 md:text-[18px]">
              We create facility systems for offices, campuses, malls, buildings, service providers, maintenance teams and facility management companies.
            </p>
            ...
            <div className="mt-12 overflow-hidden rounded-[28px] bg-[#f6f8fc] p-8 shadow-[0_22px_70px_rgba(0,0,0,0.05)]">
              <h3 className="max-w-110 text-[30px] font-semibold leading-[1.15] tracking-[-0.8px] text-[#0f5f95] md:text-[34px]">
                Build Smarter Facility Platforms
              </h3>
              <a
                href="/contact"
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
            <div>
              ...
              <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Essential features for a complete facility management platform.
              </h2>
            </div>
            <p className="max-w-185 text-[16px] font-light leading-[1.7] text-black/65">
              We build facility platforms with practical features for admins, maintenance staff, vendors, occupants, clients and management teams.
            </p>
          </div>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Reliable facility software for daily operations.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.75] text-black/65">
              Facility platforms manage important asset, staff, vendor and operational data. We focus on secure access, protected APIs, cloud backup, activity logs and reliable performance.
            </p>
          </div>
          ...
          <div className="mb-14 flex flex-col justify-between gap-7 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="max-w-195 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Facility platforms built for real operational improvement.
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-210 text-[38px] font-light leading-[1.1] tracking-[-1.7px] text-[#262626] md:text-[48px] lg:text-[54px]">
              Technologies powering smart facility platforms
            </h2>
            <p className="mx-auto mt-6 max-w-220 text-[17px] font-light leading-[1.75] tracking-[-0.2px] text-[#525252] md:text-[19px]">
              ...
              to build facility platforms with performance, reliability and scalability.
            </p>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              We build facility platforms around maintenance, automation and operational control.
            </h2>
          </div>
          <div className="grid gap-x-12 gap-y-8 md:grid-cols-2">
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative overflow-hidden bg-[#f6f8fc] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.08)]">
            <img
              ...
              alt="Facility Management Support and Maintenance"
              className="h-full w-full object-cover"
            />
          </div>
          <div>
            <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.18em] text-[#3C5B9B]">
              Facility Support & Growth
            </p>
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Support that keeps your facility platform reliable.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.7] text-black/65">
              Facility software needs continuous updates, workflow improvements, monitoring and performance optimization. We support your platform after launch.
            </p>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 text-center">
            ...
            <h2 className="mx-auto max-w-230 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Common questions about facility management software development.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-450 px-8 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#3C5B9B] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                src="/about.avif"
                alt="BrainADZ Live Facility Management Software"
                loading="lazy"
                decoding="async"
                className="h-full w-full object-cover"
              />
            ...
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-145">
                <h3 className="text-[20px] font-semibold leading-tight text-white md:text-[26px] lg:text-[30px]">
                  Ready to build your facility platform?
                </h3>
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Let BrainADZ Live help you create a scalable, operations-ready and maintenance-focused facility management solution.
                </p>
              </div>
              <a
                href="/contact"
