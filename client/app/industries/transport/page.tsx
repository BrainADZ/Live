...
const workflow = [
  {
    title: "Transport Workflow Discovery",
    text: "We understand your fleet, routes, drivers, bookings, dispatch flow, delivery process and operational goals.",
    icon: Search,
  },
  {
    title: "Mobility Architecture Planning",
    text: "We plan vehicle tracking, route management, booking flow, driver panels, admin dashboards and cloud infrastructure.",
    icon: Layers3,
  },
  {
    title: "UI/UX & Prototype",
    text: "We design clean dashboards, driver apps, customer booking screens and real-time transport management interfaces.",
    icon: MonitorSmartphone,
  },
  {
    title: "Secure Platform Development",
    text: "We build core transport modules including tracking, bookings, dispatch, fleet, billing, notifications and reporting.",
    icon: Code2,
  },
  {
    title: "GPS & System Integration",
    text: "We integrate maps, GPS tracking, payment gateways, APIs, notifications, ERPs and third-party transport tools.",
    icon: Workflow,
  },
  {
    title: "Testing & Optimization",
    text: "We test location accuracy, performance, route flow, user roles, data security and platform reliability.",
    icon: ShieldCheck,
  },
  {
    title: "Cloud Deployment",
    text: "We deploy your transport platform on reliable cloud infrastructure with proper monitoring and backup setup.",
    icon: Rocket,
  },
  {
...
const transportBenefits = [
  {
    ...
    text: "Track vehicles, routes, drivers and deliveries through real-time dashboards.",
    icon: MapPinned,
  },
  {
    title: "Faster Dispatch",
    text: "Manage bookings, driver allocation, route planning and trip status from one system.",
    icon: Rocket,
  },
  {
    title: "Better Fleet Control",
    text: "Monitor vehicle usage, fuel, maintenance, delays and fleet performance.",
    icon: Truck,
  },
  {
    title: "Smarter Decisions",
    text: "Use analytics to improve delivery time, route efficiency and operational cost.",
    icon: BarChart3,
  },
];
...
const challenges = [
  {
    ...
    text: "Replace manual booking, dispatch and trip tracking with a connected digital platform.",
  },
  {
    title: "Limited Vehicle Visibility",
    text: "Track vehicles, drivers, routes and delivery status in real time.",
  },
  {
    title: "Route Inefficiency",
    text: "Improve route planning, reduce delays and optimize transport movement.",
  },
  {
    title: "Disconnected Operations",
    text: "Connect customers, drivers, fleet teams, dispatchers and admins in one workflow.",
  },
];
...
const solutions = [
  {
    ...
    text: "Manage vehicles, drivers, routes, maintenance, fuel, trips and fleet performance from one dashboard.",
    icon: Truck,
  },
  {
    title: "Transport Booking Platform",
    text: "Create booking flows for passengers, shipments, logistics, rentals and transport services.",
    icon: Bus,
  },
  {
    title: "Route Optimization System",
    text: "Plan smarter routes, reduce delays, optimize deliveries and improve vehicle utilization.",
    icon: Route,
  },
  {
    title: "Driver Management App",
    text: "Give drivers trip details, route guidance, delivery updates, payments and task status.",
    icon: Users,
  },
  {
  ...
  {
    title: "Transport Analytics Platform",
    text: "Analyze trip performance, driver activity, delivery time, cost and fleet efficiency.",
    icon: BarChart3,
  },
];
...
const transportTypes = [
  {
    ...
    text: "We build fleet management systems for tracking vehicles, drivers, routes, fuel, maintenance, trip status and operational performance across your transport network.",
    icon: Truck,
  },
  {
    title: "Logistics & Delivery Systems",
    text: "Our logistics platforms help manage shipments, delivery tracking, driver allocation, customer updates, route planning and proof-of-delivery workflows.",
    icon: PackageCheck,
  },
  {
    title: "Passenger Transport Apps",
    text: "We create passenger transport apps for bookings, seat management, trip status, ticketing, payments, driver details and notifications.",
    icon: Bus,
  },
  {
    title: "Route Planning Solutions",
    text: "We develop route planning tools that help reduce travel time, improve vehicle usage, manage delivery zones and optimize transport operations.",
    icon: Route,
  },
  {
    title: "Driver & Dispatcher Panels",
    text: "We design driver and dispatcher systems for trip allocation, live status updates, route instructions, task completion and internal communication.",
    icon: Users,
  },
  {
    title: "Transport Analytics Dashboards",
    text: "We build dashboards that help transport businesses track delays, trip costs, driver performance, route efficiency and business KPIs.",
    icon: BarChart3,
  },
];
...
const caseStudies = [
  {
    ...
    text: "A digital fleet platform for vehicle tracking, driver management, route planning and maintenance alerts.",
    image: "/industries/transport/fleet-management.jpg",
  },
  {
    title: "Logistics Tracking System",
    text: "A real-time logistics dashboard for shipment tracking, delivery status, driver updates and customer notifications.",
    image: "/industries/transport/logistics-tracking.jpg",
  },
  {
    title: "Passenger Booking App",
    text: "A transport booking app with seat booking, route details, trip tracking, ticketing and payments.",
    image: "/industries/transport/passenger-booking.jpg",
  },
  {
    title: "Route Analytics Dashboard",
    text: "A transport analytics platform for route efficiency, delivery delays, driver activity and operational insights.",
...
const whyChoose = [
  {
    title: "Transport Workflow Understanding",
    text: "We design platforms around real fleet, logistics, booking, driver and dispatch operations.",
  },
  {
    title: "Tracking-Ready Architecture",
    text: "We build systems that support GPS tracking, route visibility, live updates and scalable data flow.",
  },
  {
    title: "Custom Development",
    text: "Your transport platform is built according to your vehicle types, users, routes and business model.",
  },
  {
...
const supportItems = [
  "Fleet platform monitoring",
  "New transport modules and features",
  "Performance and speed optimization",
  "Security updates and access improvements",
  "Dashboard, route and reporting upgrades",
];
...
const faqs = [
  {
    q: "Do you build transport management software?",
    a: "Yes, we build custom transport management platforms for fleets, logistics, passenger transport, delivery businesses and mobility startups.",
  },
  {
  ...
  {
    q: "Can you integrate GPS tracking?",
    a: "Yes, we can integrate GPS tracking, live route maps, trip status, vehicle movement and location-based notifications.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, we can build multi-branch transport platforms with branch-wise fleet data, centralized admin access and reporting.",
  },
  {
  ...
  return (
    <main className="bg-white text-[#111827]">
      ...
      <section className="relative min-h-105 overflow-hidden bg-black text-white md:min-h-120 lg:min-h-135">
        <img
          src="/industries/transport/transport-hero.jpg"
          alt="Transport Software Solutions"
        ...
        <div className="relative z-10 mx-auto flex min-h-135 max-w-450 flex-col px-5 py-10 md:min-h-150 md:px-8 lg:min-h-135 lg:px-12">
          ...
          <div className="mt-12 max-w-205 md:mt-14">
            <h1 className="text-[38px] font-semibold leading-[1.15] tracking-[-1.2px] text-white md:text-[48px] lg:text-[56px]">
              Transport Software Solutions
            </h1>
          </div>

          <div className="mt-auto pb-8 md:pb-9 lg:pb-10">
            <p className="max-w-195 text-[14px] font-light leading-[1.45] tracking-[-0.3px] text-white/90 md:text-[16px] lg:text-[18px]">
              Smart, scalable and tracking-ready transport platforms for fleets,
              logistics, passenger mobility, delivery operations and transport businesses.
            </p>
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="max-w-170 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Digital transport systems built for visibility, speed and control.
            </h2>
            <p className="mt-6 max-w-165 text-[16px] font-light leading-[1.75] text-black/70">
              BrainADZ Live helps transport companies build custom platforms for
              fleet management, GPS tracking, booking, route planning, dispatch,
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Solving real operational problems in transport.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-220 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Custom platforms for fleet, logistics, booking and mobility operations.
            </h2>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          <div>
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              A connected architecture for transport operations.
            </h2>
            <p className="mt-5 max-w-165 text-[16px] font-light leading-[1.7] text-black/65">
              We plan transport systems with connected modules for customers,
              drivers, dispatchers, fleet managers, payments, GPS tracking and analytics.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="relative z-10 mx-auto mb-12 max-w-[1180px] text-center lg:mb-14">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] text-black md:text-[46px] lg:text-[54px]">
              Our transport software development roadmap
            </h2>

            <p className="mx-auto mt-5 max-w-[980px] text-[16px] font-light leading-[1.7] text-black/65 md:text-[20px]">
              From transport workflow discovery to secure deployment, we follow
          ...
          <div className="relative hidden h-[1060px] lg:block">
            ...
            >
              ...
              <path d="M 392 43 L 1208 43" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#transport-zigzag-arrow)" />
              ...
              <path d="M 1208 343 L 392 343" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#transport-zigzag-arrow)" />
              <path d="M 306 343 C 118 343 78 468 102 535 C 126 598 205 613 306 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#transport-zigzag-arrow)" />
              <path d="M 392 613 L 1208 613" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#transport-zigzag-arrow)" />
              ...
              <path d="M 1208 913 L 392 913" stroke="#3C5B9B" strokeDasharray="10 12" strokeLinecap="round" strokeWidth="2.5" markerEnd="url(#transport-zigzag-arrow)" />
            </svg>
        ...
        <div className="mx-auto grid max-w-450 gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <h2 className="max-w-175 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Types of transport solutions we develop
            </h2>
            <p className="mt-6 max-w-170 text-[16px] font-light leading-[1.75] text-black/70 md:text-[18px]">
              We create transport systems for fleet companies, logistics providers,
              delivery businesses, passenger mobility services and transport startups.
            </p>
            ...
            <div className="mt-12 overflow-hidden rounded-[28px] bg-[#f6f8fc] p-8 shadow-[0_22px_70px_rgba(0,0,0,0.05)]">
              <h3 className="max-w-110 text-[30px] font-semibold leading-[1.15] tracking-[-0.8px] text-[#0f5f95] md:text-[34px]">
                Build Smarter Transport Systems
              </h3>
              <a
                href="/contact"
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
            <div>
              ...
              <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Essential features for a complete transport platform.
              </h2>
            </div>
            <p className="max-w-185 text-[16px] font-light leading-[1.7] text-black/65">
              We build transport platforms with practical features for customers,
              drivers, dispatchers, fleet managers and business teams.
            </p>
          </div>
      ...
      <section className="bg-white px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Reliable transport software for live operations.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.75] text-black/65">
              Transport platforms depend on accurate data, live tracking and secure
          ...
          <div className="mb-14 flex flex-col justify-between gap-7 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="max-w-195 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
                Transport platforms built for real operational improvement.
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-14 text-center">
            ...
            <h2 className="mx-auto max-w-210 text-[38px] font-light leading-[1.1] tracking-[-1.7px] text-[#262626] md:text-[48px] lg:text-[54px]">
              Technologies powering smart transport platforms
            </h2>
            <p className="mx-auto mt-6 max-w-220 text-[17px] font-light leading-[1.75] tracking-[-0.2px] text-[#525252] md:text-[19px]">
              ...
              to build transport platforms with tracking, performance and scalability.
            </p>
          </div>
      ...
      <section className="bg-[#f6f8fc] px-5 py-18 md:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.72fr_1.28fr]">
          <div className="lg:sticky lg:top-24 lg:h-fit">
            ...
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              We build transport platforms around visibility, automation and growth.
            </h2>
          </div>
          <div className="grid gap-x-12 gap-y-8 md:grid-cols-2">
        ...
        <div className="mx-auto grid max-w-450 gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative overflow-hidden bg-[#f6f8fc] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.08)]">
            <img
              ...
              alt="Transport Support and Maintenance"
              className="h-full w-full object-cover"
            />
          </div>
          <div>
            <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.18em] text-[#3C5B9B]">
              Transport Support & Growth
            </p>
            <h2 className="text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Support that keeps your transport platform reliable.
            </h2>
            <p className="mt-5 text-[16px] font-light leading-[1.7] text-black/65">
              Transport software needs continuous updates, tracking improvements,
        ...
        <div className="mx-auto max-w-450">
          <div className="mb-12 text-center">
            ...
            <h2 className="mx-auto max-w-230 text-[34px] font-light leading-[1.15] tracking-[-1px] md:text-[46px]">
              Common questions about transport software development.
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-450 px-8 lg:px-10">
          <div className="flex min-h-65 overflow-hidden rounded-none bg-[#3C5B9B] md:min-h-75">
            <div className="hidden w-[32%] shrink-0 md:block">
              <img
                src="/about.avif"
                alt="BrainADZ Live Transport Software"
                loading="lazy"
                decoding="async"
                className="h-full w-full object-cover"
              />
            ...
            <div className="flex flex-1 flex-col justify-center gap-8 px-7 py-10 md:flex-row md:items-center md:justify-between md:px-10 lg:px-14">
              <div className="max-w-145">
                <h3 className="text-[20px] font-semibold leading-tight text-white md:text-[26px] lg:text-[30px]">
                  Ready to build your transport platform?
                </h3>
                <p className="mt-4 text-[16px] font-light leading-[1.55] text-white">
                  Let BrainADZ Live help you create a scalable, tracking-ready
                  and operations-focused transport solution.
                </p>
              </div>
              <a
                href="/contact"
